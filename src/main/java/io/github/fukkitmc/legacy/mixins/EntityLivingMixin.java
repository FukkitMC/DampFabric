...
public abstract class EntityLivingMixin implements EntityLivingExtra{
    @Shadow public abstract AttributeMapBase getAttributeMap();

    @Shadow public int as;

    @Shadow public abstract ItemStack[] as();

    @Shadow public AttributeMapBase c;

    @Shadow public Map<Integer, MobEffect> effects;

    @Shadow public abstract float getHealth();

    @Shadow public int hurtTicks;

    @Shadow public int hurtTimestamp;

    @Shadow public int deathTicks;

    @Shadow public abstract float getAbsorptionHearts();
